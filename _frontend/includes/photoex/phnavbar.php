...
<nav class="navbar navbar-expand bg-white navbar-white sticky-top px-4 py-0 border-bottom" style="border-bottom: 3px solid #dc3545 !important;">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex" id="navname">photographer</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-white border-0 rounded-0 rounded-bottom m-0">
                            <a href="<?= page('photographer/photoportfolio.php') ?>" class="dropdown-item">My Profile</a>
            ...
            <script>
                window.addEventListener("load", function(){
                    ...
                    $ufname = $udetails.photographer_fname;
                    $uimg = $udetails.photographer_image;
