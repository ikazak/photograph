...
<head>
    ...
    <style>
        ...
        .back-button {
            ...
            /* Positioning the button on the top-left */
            position: fixed;
            top: 20px;
            left: 20px;
            z-index: 1000;
...
<body>
                    ...
                    <div class="w-100" style="max-width: 400px;">
                        ...
                        <form id="registerForm">
                            <div class="form-floating mb-3">
                                <input name="name" type="text" class="form-control" id="fname" placeholder="juan" required>
                            ...
                            <div class="form-floating mb-3">
                                <input name="username" type="email" class="form-control" id="email" placeholder="name@example.com" required>
                                <label for="email">Email address</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input name="contact" type="number" class="form-control" id="email" placeholder="09534479203" required>
                            ...
                            <button type="submit" class="btn py-3 w-100 mb-4" id="login-button">REGISTER</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <?=import_packages("tyrux","twal","loading")?>
    ...
    registerForm.addEventListener("submit", function() {
        ...
        $data = DOM.form_object("#registerForm");
        ...
        tyrax.post({
            ...
            response: (send) => {
                ...
                if (send.code == 200) {
                    twal.ok({
                        text: send.message
                    }).then(() => location.href="?page=loginpage")
                }
            }
        })
    })
