...
<body>
    ...
    <header class="hero-section">
        <img src="<?=assets()?>/img/graduation.jpg"
    ...
    <main>
        ...
        <section class="content-section">
            <p>Celebrate Life’s Joyful Moments with PPhotography</p>
            <p>
                

Step into a world of laughter, joy, and unforgettable memories as you explore our birthday event photography gallery. At Cimmaroon Photography, we believe every birthday is a unique celebration deserving of creative and heartfelt documentation. Our clients have shown us how beautifully their special days can be captured, from intimate family gatherings to grand milestone parties.
            </p>
            <p>
                From candid smiles to heartfelt toasts, our birthday photography captures the essence of each celebration. Whether it's a whimsical theme, a cherished tradition, or a vibrant party atmosphere, our clients have woven their unique narratives into their birthday photos, creating memories that will be cherished for a lifetime.
    ...
    <div class="gallery-container">
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad1.jpg" alt="Couple in a field at sunset">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad2.jpg" alt="Woman in blue dress by water">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad3.jpg" alt="Couple under an umbrella with smoke">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad4.jpg" alt="Couple sitting on a sofa indoors">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad5.jpg" alt="Close-up of couple smiling">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad6.jpg" alt="Couple standing in a garden">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad7.jpg" alt="Couple in white formal wear">
        </div>
        <div class="gallery-item">
            <img src="<?=assets()?>/img/grad8.jpg" alt="Close-up of a person's ear">
        </div>
        </div>
